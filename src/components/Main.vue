  ...
  <div class="mainsection">
    ...
    <div>
      ...
      >
        ...
        <b-tab title="Components"><p><api2></api2></p></b-tab>
...
import api4 from '../components/api4.vue';
import api5 from '../components/api5.vue';
import api6 from '../components/api6.vue';
export default {
  components: {
    api1,
    api2,
